            ...
            <div class="container-fluid">
                ...
                <div class="row">
						...
						<?php
										...
										$result1 = mysql_query("SELECT * FROM analisis_kualitas, lokasi where lokasi.id='$idr' ORDER BY tanggal_pengamatan DESC");// or die("Invalid query");
                    ...
                    <div class="col-lg-12" style="margin:0; padding:0">
                        <center><h2>History Analisis <?php echo $lok;?></h2>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-hover">
								...
								<tbody>
										...
										$result = mysql_query("SELECT * FROM analisis_kualitas, lokasi where lokasi.id='$idr' and lokasi.id=analisis_kualitas.id ORDER BY tanggal_pengamatan DESC");// or die("Invalid query");
										...
										while ($row = mysql_fetch_assoc($result)) {
											...
											echo "<td><center><a href=\"openhistory.php?id=$id\"><button type=\"button\" class=\"btn btn-lg btn-success\">View</button></a></td></tr>";
						...
						<center><a href="analisis_kualitas.php" class="btn btn-primary" role="button">BACK</a><br><br>
                </div>
                <!-- /.row -->
